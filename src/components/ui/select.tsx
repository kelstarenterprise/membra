  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "bg-input px-4 py-2.5 text-sm whitespace-nowrap transition-all duration-200 ease-in-out",
        ...
        "dark:data-[placeholder]:text-muted-foreground dark:focus:border-ring dark:focus:ring-ring/20",
