  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex h-10 w-full items-center justify-between gap-2 rounded-lg border border-blue-200",
        "bg-white px-4 py-2.5 text-sm whitespace-nowrap transition-all duration-200 ease-in-out",
        
        // Text and placeholder colors
        "text-blue-900 data-[placeholder]:text-blue-400",
        
        // Focus states
        "focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none",
        
        // Dark mode support
        "dark:border-blue-600 dark:bg-blue-900/20 dark:text-blue-100",
        "dark:data-[placeholder]:text-blue-400 dark:focus:border-blue-400 dark:focus:ring-blue-400/20",
        ...
        // Icon styles
        "[&_svg:not([class*='text-'])]:text-blue-500 [&_svg]:pointer-events-none [&_svg]:shrink-0",
